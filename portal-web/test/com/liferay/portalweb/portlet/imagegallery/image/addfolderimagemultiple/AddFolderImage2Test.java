 ...
 */
public class AddFolderImage2Test extends BaseTestCase {
	public void testAddFolderImage2() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (RuntimeVariables.replace("Test2 Image2")
										.equals(selenium.getText("//a[2]/span"))) {
					break;
				}
			}
			catch (Exception e) {
