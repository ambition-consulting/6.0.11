 ...
 */
public class ConfigurePortletDynamicCurrentWikiPageTest extends BaseTestCase {
	public void testConfigurePortletDynamicCurrentWikiPage()
		throws Exception {
		...
		selenium.saveScreenShotAndSource();
		assertTrue(selenium.isPartialText("_86_currentClassNameIds", "Wiki Page"));
