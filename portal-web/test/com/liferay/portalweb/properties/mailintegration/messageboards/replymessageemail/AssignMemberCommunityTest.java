 ...
 */
public class AssignMemberCommunityTest extends BaseTestCase {
	public void testAssignMemberCommunity() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 2:
				...
				boolean userAssigned = selenium.isChecked("_134_allRowIds");
