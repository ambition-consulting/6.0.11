 ...
 */
public class TearDownCommunityInactiveTest extends BaseTestCase {
	public void testTearDownCommunityInactive() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 1:
				...
				selenium.waitForPageToLoad("30000");
				selenium.saveScreenShotAndSource();
				selenium.type("_134_name", RuntimeVariables.replace("Inactive"));
				selenium.saveScreenShotAndSource();
