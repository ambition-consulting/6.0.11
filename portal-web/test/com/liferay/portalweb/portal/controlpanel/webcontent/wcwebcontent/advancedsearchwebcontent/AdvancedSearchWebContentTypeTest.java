 ...
 */
public class AdvancedSearchWebContentTypeTest extends BaseTestCase {
	public void testAdvancedSearchWebContentType() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 2:
				...
				for (int second = 0;; second++) {
					...
					try {
						if (selenium.isVisible("_15_type")) {
							break;
						}
					}
					catch (Exception e) {
