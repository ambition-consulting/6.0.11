 ...
 */
public class AdvancedSearchWebContentStatusTest extends BaseTestCase {
	public void testAdvancedSearchWebContentStatus() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 2:
				...
				for (int second = 0;; second++) {
					...
					try {
						if (selenium.isVisible("_15_status")) {
							break;
						}
					}
					catch (Exception e) {
