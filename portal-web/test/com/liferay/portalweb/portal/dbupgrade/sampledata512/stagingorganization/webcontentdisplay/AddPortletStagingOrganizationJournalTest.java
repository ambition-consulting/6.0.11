 ...
 */
public class AddPortletStagingOrganizationJournalTest extends BaseTestCase {
	public void testAddPortletStagingOrganizationJournal()
		throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible("//div[@id='CMS-Journal']/p/a")) {
					break;
				}
			}
			catch (Exception e) {
