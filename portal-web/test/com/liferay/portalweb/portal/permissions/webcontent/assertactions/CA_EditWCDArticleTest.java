 ...
 */
public class CA_EditWCDArticleTest extends BaseTestCase {
	public void testCA_EditWCDArticle() throws Exception {
		...
		selenium.type("_15_title",
			RuntimeVariables.replace("CA Permissions WCD Article Edit"));
		selenium.saveScreenShotAndSource();
		Thread.sleep(5000);
		...
		selenium.type("//body",
			RuntimeVariables.replace(
				"This is an edited ca permissions wcd article!"));
