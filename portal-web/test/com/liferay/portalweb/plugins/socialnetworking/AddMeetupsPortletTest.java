 ...
 */
public class AddMeetupsPortletTest extends BaseTestCase {
	public void testAddMeetupsPortlet() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isElementPresent("//div[@title='Meetups']/p/a")) {
					break;
				}
			}
			catch (Exception e) {
