...
public class AddMBMessage17Test extends BaseTestCase {
	public void testAddMBMessage17() throws Exception {
		...
		selenium.type("_19_subject",
			RuntimeVariables.replace("MB17 Message17 Subject17"));
		selenium.saveScreenShotAndSource();
		selenium.type("_19_textArea",
			RuntimeVariables.replace("MB17 Message17 Body17"));
		selenium.saveScreenShotAndSource();
		...
		selenium.waitForPageToLoad("30000");
		selenium.saveScreenShotAndSource();
		assertEquals(RuntimeVariables.replace("MB17 Message17 Subject17"),
