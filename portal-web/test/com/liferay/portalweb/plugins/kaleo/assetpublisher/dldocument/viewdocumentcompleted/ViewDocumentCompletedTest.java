 ...
 */
public class ViewDocumentCompletedTest extends BaseTestCase {
	public void testViewDocumentCompleted() throws Exception {
		...
		assertEquals(RuntimeVariables.replace("test_document.txt"),
			selenium.getText("//div[2]/div[1]/div/span/a/span"));
