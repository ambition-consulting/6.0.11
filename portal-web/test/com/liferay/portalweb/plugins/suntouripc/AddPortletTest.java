...
public class AddPortletTest extends BaseTestCase {
	public void testAddPortlet() throws Exception {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible("//div[@title='Tour Listing']/p/a")) {
					break;
				}
			}
			catch (Exception e) {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible("//div[@title='Tour Map']/p/a")) {
					break;
				}
			}
			catch (Exception e) {
		...
		for (int second = 0;; second++) {
			...
			try {
				if (selenium.isVisible("//div[4]/section")) {
					break;
				}
			}
			catch (Exception e) {
		...
		selenium.saveScreenShotAndSource();
		assertTrue(selenium.isVisible("//div[4]/section"));
	}
}