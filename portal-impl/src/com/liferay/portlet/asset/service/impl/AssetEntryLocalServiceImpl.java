...
public class AssetEntryLocalServiceImpl extends AssetEntryLocalServiceBaseImpl {
	...
	public AssetEntryDisplay[] searchEntryDisplays(
		...
		return searchEntryDisplays(
			companyId, null, portletId, keywords, languageId, start, end);
	}
	...
	public int searchEntryDisplaysCount(
		...
		return searchEntryDisplaysCount(
			companyId, null, portletId, keywords, languageId);
	}
	...
	protected AssetEntry getEntry(Document document)
		...
		if (portletId.equals(PortletKeys.BLOGS)) {
			...
			long repositoryId = GetterUtil.getLong(
				document.get("repositoryId"));
			String name = document.get("path");
