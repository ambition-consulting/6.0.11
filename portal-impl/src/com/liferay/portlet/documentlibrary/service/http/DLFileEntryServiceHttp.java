...
public class DLFileEntryServiceHttp {
	...
	public static com.liferay.portlet.documentlibrary.model.DLFileEntry getFileEntryByTitle(
		...
		try {
			MethodKey methodKey = new MethodKey(DLFileEntryServiceUtil.class.getName(),
					"getFileEntryByTitle", _getFileEntryByTitleParameterTypes12);
	...
	public static int getFoldersFileEntriesCount(HttpPrincipal httpPrincipal,
		...
		try {
			MethodKey methodKey = new MethodKey(DLFileEntryServiceUtil.class.getName(),
					...
					_getFoldersFileEntriesCountParameterTypes15);
	...
	private static final Class<?>[] _getFileEntryByTitleParameterTypes12 = new Class[] {
			long.class, long.class, java.lang.String.class
		};
	...
	private static final Class<?>[] _getFoldersFileEntriesCountParameterTypes15 = new Class[] {
