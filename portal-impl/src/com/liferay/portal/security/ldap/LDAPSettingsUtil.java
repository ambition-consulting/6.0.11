...
public class LDAPSettingsUtil {
	...
	/**
	 * @deprecated {@link AuthSettingsUtil#isLDAPAuthEnabled(long)}
	 */
	public static boolean isAuthEnabled(long companyId) throws SystemException {
		return AuthSettingsUtil.isLDAPAuthEnabled(companyId);
	}
	...
	/**
	 * @deprecated {@link AuthSettingsUtil#isNtlmEnabled(long)}
	 */
	public static boolean isNtlmEnabled(long companyId)
		throws SystemException {

		return AuthSettingsUtil.isNtlmEnabled(companyId);
	}
	...
	/**
	 * @deprecated {@link AuthSettingsUtil#isSiteMinderEnabled(long)}
	 */
	public static boolean isSiteMinderEnabled(long companyId)
		throws SystemException {

		return AuthSettingsUtil.isSiteMinderEnabled(companyId);
	}
